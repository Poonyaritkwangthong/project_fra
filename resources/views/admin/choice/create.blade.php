        ...
        <div class="border w-[30rem] h-full p-[2rem] rounded-3xl shadow-2xl">
            ...
            <form action="{{ route('choice.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-[1rem] items-center mt-[1rem]">
                            <div>
                                ...
                                <label class="bg-green-300 p-2 rounded-lg" for="c_status_start">เปิดใช้งาน</label>
                            </div>
                            <div>
                                <input type="radio" name="c_status" value="stop" id="c_status_stop">
                                <label class="bg-red-300 p-2 rounded-lg" for="c_status_stop">หยุดใช้งาน</label>
                            </div>
                ...
                <div class="flex justify-end mr-[1rem]">
                    <buttonห type="submit">บันทึกคำถาม</button>
                </div>
            </form>
        </div>
    @endsection
