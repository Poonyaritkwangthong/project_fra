                ...
                <div class="mb-[1rem] border-b border-white">
                    ...
                    <div class="flex gap-4">
                        <div class="mb-4">
                            ...
                            <input class="rounded-lg w-[6rem] pl-2 p-2" type="text" name="question" id="question" required>
                        </div>
                        <div class="mb-4">
                            <label for="question">เกี่ยวข้องเป็น</label><br>
                            <input class="rounded-lg w-[22rem] pl-2 p-2" type="text" name="question" id="question" required>
                        </div>
                    </div>
                </div>
                <div class="">
                    ...
                    <div class="flex gap-7">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="rounded-lg w-[6em] pl-2 p-2" type="text" name="question" id="question" required>
                        </div>
                    </div>
                </div>
            </div>
